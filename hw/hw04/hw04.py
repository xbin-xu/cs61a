...
def balanced(m):
    ...
    if is_planet(m):
        ...
        left_mass = length(left_arm) * total_mass(end(left_arm))
        right_mass = length(right_arm) * total_mass(end(right_arm))
        return (
            left_mass == right_mass
            and balanced(end(left_arm))
            and balanced(end(right_arm))
        )
