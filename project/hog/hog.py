...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    cur_rolls, sum, sow_sad = 0, 0, False
    while cur_rolls < num_rolls:
        tmp = dice()
        sow_sad |= tmp == 1
        sum, cur_rolls = sum + tmp, cur_rolls + 1
...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    return (
        ...
        if num_rolls
        else boar_brawl(player_score, opponent_score)
    )
    # END PROBLEM 3
...
def sus_points(score):
    ...
    return next_prime(score) if is_sus(score) else score
    # END PROBLEM 4
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    player_score, first_roll = 0, strategy(0, 0)
...
def make_averaged(original_function, samples_count=1000):
    ...
    def average(*args):
        ...
        while cnt < samples_count:
            sum, cnt = sum + original_function(*args), cnt + 1
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    n, max_average, num_rolls = 1, 0, 1
    while n <= 10:
        cur_average = make_averaged(roll_dice, samples_count)(n, dice)
        if max_average < cur_average:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return sus_strategy(score, opponent_score, threshold=18, num_rolls=6)
    # END PROBLEM 12
